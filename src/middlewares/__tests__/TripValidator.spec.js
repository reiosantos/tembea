...
describe('Trip Validator', () => {
    ...
    describe('validateAll method', () => {
        ...
        it('should call validateAll with all values ', async (done) => {
        ...
        it('should call validateAll with missing driverPhoneNo ', (done) => {
        ...
        it('should call validateAll with missing tripId ', (done) => {
            HttpError.sendErrorResponse = jest.fn(() => { });
